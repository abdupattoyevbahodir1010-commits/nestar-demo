    ...
    <Stack className={"filter-main"}>
      ...
      <Stack className={"find-your-home"} mb={"30px"}>
        ...
        <Stack className={"button-group"}>
          <Button sx={{ borderRadius: "12px 0 0 12px", border: "1px solid #b0b0b0" }}>Any</Button>
          <Button sx={{ borderRadius: 0, border: "1px solid #b0b0b0" }}>1</Button>
          <Button sx={{ borderRadius: 0, border: "2px solid #181a20" }}>2</Button>
          <Button sx={{ borderRadius: 0, border: "1px solid #b0b0b0" }}>3</Button>
          <Button sx={{ borderRadius: 0, border: "2px solid #181a20" }}>4</Button>
          <Button sx={{ borderRadius: "0 12px 12px 0", border: "1px solid #b0b0b0" }}>5+</Button>
        </Stack>
      </Stack>
      <Stack className={"find-your-home"} mb={"30px"}>
        ...
        <Stack className={"button-group"}>
          ...
          <Button sx={{ borderRadius: 0, border: "2px solid #181A20" }}>2</Button>
          <Button sx={{ borderRadius: 0, border: "1px solid #b0b0b0" }}>3</Button>
          <Button sx={{ borderRadius: 0, border: "1px solid #b0b0b0" }}>4</Button>
          <Button sx={{ borderRadius: "0 12px 12px 0", border: "1px solid #b0b0b0" }}>5+</Button>
        </Stack>
      </Stack>
      <Stack className={"find-your-home"} mb={"30px"}>
      ...
      <Stack className={"find-your-home"} mb={"30px"}>
        ...
        <Stack className={"square-year-input"}>
          <FormControl>
            <InputLabel id="demo-simple-select-label-Min">Min</InputLabel>
          ...
          <FormControl>
            <InputLabel id="demo-simple-select-label-Max">Max</InputLabel>
            <Select labelId={"demo-simple-select-label"} id={"demo-simple-select"} value={100} label={"Max"}>
              {propertySquare.map((square: number) => (
                <MenuItem value={square} key={square}>{square}</MenuItem>
              ))}
            </Select>
